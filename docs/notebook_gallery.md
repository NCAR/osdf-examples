...
| Notebook | Description | Tags |
|---|---|---|
| [`cmip6_gmst_zarr.ipynb`](../notebooks/cmip6_gmst_zarr.ipynb) | Multi-model GMST from CMIP6 zarr (~27 GCMs), compared to HadCRUT5 | <a class="tag-link" href="tag-index#tag-dataset-cmip6"><span class="tag tag-dataset">dataset:cmip6</span></a> <a class="tag-link" href="tag-index#tag-task-visualization"><span class="tag tag-task">task:visualization</span></a> |
